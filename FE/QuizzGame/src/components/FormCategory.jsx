...
const FormCategory = () => {
  ...
  return (
    ...
    <div className="flex justify-center items-center min-h-screen h-screen bg-gradient-to-tl from-purple-400 to-pink-500">
      <form
        onSubmit={handleSubmit}
        className="w-11/12 max-w-[1100px] p-5 md:p-8 bg-white shadow rounded-lg space-y-8"
      >
        <h2 className="text-6xl font-medium text-blue-800 mb-6 text-center">Setup Your Question</h2>
